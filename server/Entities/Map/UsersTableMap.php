...
/**
 * This class defines the structure of the 'ticusers' table.
 *
 *
 *
...
class UsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Entities.Map.UsersTableMap';
     ...
     */
    const TABLE_NAME = 'ticusers';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Entities\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Entities.Users';
     ...
     */
    const COL_ID = 'ticusers.id';

    /**
     * the column name for the email field
     */
    const COL_EMAIL = 'ticusers.email';

    /**
     * the column name for the password field
     */
    const COL_PASSWORD = 'ticusers.password';

    /**
     * the column name for the firstname field
     */
    const COL_FIRSTNAME = 'ticusers.firstname';

    /**
     * the column name for the lastname field
     */
    const COL_LASTNAME = 'ticusers.lastname';

    /**
     * the column name for the permission field
     */
    const COL_PERMISSION = 'ticusers.permission';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'Password', 'Firstname', 'Lastname', 'Permission', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'password', 'firstname', 'lastname', 'permission', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_EMAIL, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_FIRSTNAME, UsersTableMap::COL_LASTNAME, UsersTableMap::COL_PERMISSION, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'password', 'firstname', 'lastname', 'permission', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'Password' => 2, 'Firstname' => 3, 'Lastname' => 4, 'Permission' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'password' => 2, 'firstname' => 3, 'lastname' => 4, 'permission' => 5, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_EMAIL => 1, UsersTableMap::COL_PASSWORD => 2, UsersTableMap::COL_FIRSTNAME => 3, UsersTableMap::COL_LASTNAME => 4, UsersTableMap::COL_PERMISSION => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'password' => 2, 'firstname' => 3, 'lastname' => 4, 'permission' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_PERMISSION);
        } else {
    ...
    /**
     * Deletes all rows from the ticusers table.
     *
     * @param ConnectionInterface $con the connection to use
